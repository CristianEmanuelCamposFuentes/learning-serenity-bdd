...
public class AddItemStepDefinitions {
    ...
    // Paso: El actor está viendo su lista de tareas.
    ...
    // Paso: El actor agrega un ítem a la lista de tareas.
    ...
    // Paso: El actor ve un ítem específico en la lista de tareas.
